#!/bin/bash
# This script is responsible for updating teh S3 bucket with the updated website contents
...
aws s3 sync src/web "s3://${WEBSITE_BUCKET}/" --delete --exclude "*.DS_Store*" --exclude "js/config.js" --region "$REGION"
